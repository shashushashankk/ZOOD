...
//        Reporter.log("Execution started at " + baseUtility.dateAndTime.convertMIliSecondToDate(result.getStartMillis()),true);
    }
...
//        Reporter.log("Execution success at " + baseUtility.dateAndTime.convertMIliSecondToDate(result.getStartMillis()),true);
    }

    @Override
    public void onTestFailure(ITestResult result) {
        // TODO Auto-generated method stub
//        Reporter.log("Execution failed at " + baseUtility.dateAndTime.convertMIliSecondToDate(result.getStartMillis()), true);
